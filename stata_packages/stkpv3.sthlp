{smcl}
{* 2018年9月17日}{...}
{cmd:help stkpv3}{right: }
{hline}

{title:简介}

{p2colset 5 25 27 2}{...}
{p2col:{hi: stkpv3} {hline 2}}绘制股价蜡烛图。
{p_end}
{p2colreset}{...}
...
{title:示例}
{phang}
{stata `"stkpv3 1, start(20180101) end(20180701)"'}
{p_end}
{phang}
{stata `"stkpv3 1, start(20180101) end(20180701) index"'}
{p_end}
