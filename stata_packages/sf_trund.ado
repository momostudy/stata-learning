...
capture program drop sf_trund
program define sf_trund
  ...
  if $PorC == 2 { /* cost frontier */
   ...
   mlvecsum `lnf' `d2' = -(normalden(`ratio2')/(`sigwi'*normal(`ratio2'))) /*
                        */ - (`epsianz')/(`sigs2') + (`sigvi2')*(`ratio1a')/((`sigs2')*(`sigstar')), eq(2)

   mlvecsum `lnf' `d3' = 0.5*( (`ratio2')*(`ratio2a') + ((`sigwi')*(`epsianz')/(`sigs2'))^2 - (`sigsta2')/(`sigvi2') /*
                        */ - (2*(`epsianz')*(`sigsta2')/(`sigs2') + (`mustar')*(1-(`sigsta2')/(`sigvi2')) )*(1/`sigstar')*(`ratio1a') ), eq(3)

   mlvecsum `lnf' `d4' = 0.5*( ((`sigvi')*(`epsianz')/(`sigs2'))^2 - (`sigsta2')/(`sigwi2') /*
                        */ + (2*(`epsianz')*(`sigsta2')/(`sigs2') - (`mustar')*(1 - (`sigsta2')/(`sigwi2')) )*(1/`sigstar')*(`ratio1a') ), eq(4)
...
mlmatsum `lnf' `h12' = cst*( /*
    */ -((`sigsta2')/((`sigvi2')*(`sigwi2')) - /*
    */ ((`ratio1a')^2*(`sigsta2'))/((`sigvi2')*(`sigwi2')) - /*
    */ ((`mustar')*(`ratio1a')*(`sigstar'))/((`sigvi2')*(`sigwi2')))), eq(1,2)
...
mlmatsum `lnf' `h13' = cst*( /*
    ...
    */ ((`mustar')*((2*(`epsi') + (`mustar'))))/(`sigvi2'))))/(2*(`sigvi2')))), eq(1,3)

mlmatsum `lnf' `h14' = cst*( /*
    ...
    */ ((2*(`sigsta2')*(`sigstar')*(`sigvi2')*(`sigwi2'))))), eq(1,4)


mlmatsum `lnf' `h22' = /*
    */ -((-(((`ratio1a')^2*(`sigsta2'))/(`sigwi2')^2)) - /*
    */ ((`mustar')*(`ratio1a')*(`sigstar'))/(`sigwi2')^2 + ((`ratio2')*(`ratio2a'))/(`sigwi2') + /*
    */ (`ratio2a')^2/(`sigwi2') - (`sigsta2')/((`sigvi2')*(`sigwi2'))), eq(2)


mlmatsum `lnf' `h23' = /*
    */ -(((4*(`epsi')*(`mustar')*(`ratio1a')*(`sigstar')^2*(`sigwi') + /*
    */ 2*(`ratio1a')^2*(`sigstar')^2*(( /*
    */ (`ratio1') - (`ratio1')*(`ratio7') + 2*(`ratio3')*(`sigstar')))*(`sigvi2')*(`sigwi') + /*
    */ 2*(`ratio1a')*(( /*
    */ (-2)*(`sigstar')^4 - (`ratio5')*(`sigvi2') + /*
    */ (`ratio1')^2*(`sigstar')^2*(`sigvi2') + /*
    */ (`ratio1')^2*(`ratio7')*(`sigstar')^2*(`sigvi2')))*(`sigwi') + /*
    */ (`sigstar')*(`sigvi2')*(( /*
    */ 2*(`ratio2a') - 2*(`ratio2')^2*(`ratio2a') - 2*(`ratio2')*(`ratio2a')^2 + /*
    */ 4*(`ratio3')*(`ratio7')*(`sigwi')))*(`sigwi2')))/ /*
    */ ((4*(`sigstar')*(`sigvi2')*(`sigwi')*(`sigwi2')))), eq(2,3)

mlmatsum `lnf' `h24' =  -(((((`sigstar')*(( /*
 */ (`ratio1')*(`ratio1a')*(`sigstar')*(`sigvi2')^2*(`sigwi2')*(( /*
 */ (`ratio1a')*(`sigstar')*(`sigwi')^3*((2*(`sigsta2') - (`sigstar')^2 + (`sigwi2')) /*
 */ ) - 2*(`ratio2')*(`ratio7')*(`sigsta2')*(`sigwi2')*(((`sigvi2') + (`sigwi2')) /*
 */ ))) + /*
 */ (`ratio1')^2*(`ratio1a')*(`sigsta2')*(`sigstar')^2*(`sigwi')^3*(( /*
 */ (`sigvi2')^2*(`sigwi2') + (`sigstar')^2*(((`sigvi2') + (`sigwi2')))^2)) + /*
 */ (`sigsta2')*(`sigvi2')^2*(`sigwi')^2*(`sigwi2')*(( /*
 */ (-2)*(`ratio1a')^2*(`ratio2')*(`sigstar')*(`sigwi2') + /*
 */ 2*(`ratio3')*(`sigstar')*(`sigwi')*(`sigwi2') + /*
 */ (`ratio1a')*(`sigwi')*(((-2)*(`sigstar')^2 + (`sigwi2') + (`ratio6')*(`sigwi2')) /*
 */ )))))))/((2*(`sigsta2')*(`sigvi2')^2*(`sigwi')^3*(`sigwi2')^3)))), eq(2,4)
...
mlmatsum `lnf' `h33' = /*
    ...
    */ ((8*(`sigsta2')^2*(`sigstar')*(`sigvi2')))), eq(3)

mlmatsum `lnf' `h34' =    -(((((`sigsta2')^2*(`sigvi2')*(( /*
 ...
 */ ((8*(`sigsta2')^2*(`sigstar')*(`sigvi2')*(`sigwi')*(`sigwi2'))))), eq(3,4)

 mlmatsum `lnf' `h44' =   -( (1/4*(( /*
 ...
 */ (`ratio1')*(`sigstar')*(((-2)*(`ratio4') + (`sigwi2'))))))))))) ))), eq(4)

matrix `H' = -(`h11', `h12', `h13', `h14' \ `h12'', `h22', `h23', `h24' \ `h13'', `h23'', `h33', `h34' \ `h14'', `h24'', `h34'', `h44')
