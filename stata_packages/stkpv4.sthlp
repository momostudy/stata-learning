{smcl}
{* 2018年9月17日}{...}
{cmd:help stkpv4}{right: }
{hline}

{title:简介}

{p2colset 5 25 27 2}{...}
{p2col:{hi: stkpv4} {hline 2}}绘制股价蜡烛图+移动平均线。
{p_end}
{p2colreset}{...}
...
{p 8 18 2}
{cmdab:stkpv4} {it: code}{cmd:,}
[{opt s:tart}{cmd:(}{it:string}{cmd:)} {opt e:nd}{cmd:(}{it:string}{cmd:)} {opt s:tock} {opt i:ndex} {opt a:dd}{cmd:(}{it:string}{cmd:)}]
...
{phang} {bf: {opt a:dd}(}{it:string}{bf:)}:添加移动平均线；{p_end}
...
{title:示例}
{phang}
{stata `"stkpv4 1, start(20180101) end(20180701)"'}
{p_end}
{phang}
{stata `"stkpv4 1, start(20180101) end(20180701) index"'}
{p_end}
{phang}
{stata `"stkpv4 1, start(20180101) end(20180701) index add(5 15 30 90)"'}
{p_end}
